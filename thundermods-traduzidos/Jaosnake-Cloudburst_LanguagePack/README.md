# 🌍 Jaosnake-Cloudburst_LanguagePack
...
Multi-language translation pack for **Cloudburst** by **TeamCloudburst**.
...
| Package | Version |
|---------|---------|
| TeamCloudburst-Cloudburst | `0.4.5` |
...
| Role | Name |
|------|------|
| Original Mod | [TeamCloudburst](https://thunderstore.io/c/riskofrain2/p/TeamCloudburst/Cloudburst/) |
