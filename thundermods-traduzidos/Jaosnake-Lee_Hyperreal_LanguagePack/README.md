# 🌍 Jaosnake-Lee_Hyperreal_LanguagePack
...
Multi-language translation pack for **Lee_Hyperreal** by **PopcornFactory**.
...
| Package | Version |
|---------|---------|
| PopcornFactory-Lee_Hyperreal | `2.2.0` |
...
| Role | Name |
|------|------|
| Original Mod | [PopcornFactory](https://thunderstore.io/c/riskofrain2/p/PopcornFactory/Lee_Hyperreal/) |
