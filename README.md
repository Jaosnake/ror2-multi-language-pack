...
2. Extraia o ZIP.
3. Copie a pasta do pacote/mod desejado para `BepInEx/plugins/`.
4. No jogo, selecione **Português (Brasil)**.

Arquivos/pastas comuns:

```text
Starstorm2/Language/pt-BR/
Sandswept/Translations/pt-BR-Sandswept.language
mods/<mod>/.../pt-BR/
```
...
2. Extract the ZIP.
3. Copy the package/mod folder you want into `BepInEx/plugins/`.
4. Select **English** in-game.

Common files/folders:

```text
Starstorm2/Language/en/
Sandswept/Translations/En-Sandswept.language
mods/<mod>/.../en/
```
...
Sandswept/Translations/Ua-Sandswept.language
mods/<mod>/.../UA/
```
...
Sandswept/Translations/Fr-Sandswept.language
mods/<mod>/.../FR/
```
...
Sandswept/Translations/Ru-Sandswept.language
mods/<mod>/.../RU/
```
...
Sandswept/Translations/Es-Sandswept.language
mods/<mod>/.../es-419/
mods/<mod>/.../es-ES/
```
...
Sandswept/Translations/Ko-Sandswept.language
mods/<mod>/.../ko/
```
...
Sandswept/Translations/Zh-CN-Sandswept.language
mods/<mod>/.../zh-CN/
```
...
Sandswept/Translations/Tr-Sandswept.language
mods/<mod>/.../tr/
```
...
| SandGlass | SandsweptTeam-Sandswept + DropPod-LookingGlass | `thundermods-traduzidos/Jaosnake-SandGlass/` | Optional patch for LookingGlass stat labels |
| UAForce | R2API.Language + Risk Of Options | `thundermods-traduzidos/Jaosnake-UAForce/` | Optional Ukrainian language enabler |
